...
import {StarshipsInfo} from './ui_components/info';
...
let  imgPath='';
 ...
 class StarshipDetail extends Component{
      componentDidMount(){  
       ...
       imgPath=`/images/starships/${this.props.match.params.id}.jpg`;
...
export default connect(mapStatetoProps,{fetchData,getFilmName})(StarshipDetail);